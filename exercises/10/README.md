...
aws_s3_bucket.state_bucket: Creation complete after 5s [id=sm-di-bane-20190623022126911700000001]

Apply complete! Resources: 1 added, 0 changed, 0 destroyed.

Outputs:

state_bucket_name = sm-di-bane-20190623022126911700000001
```
